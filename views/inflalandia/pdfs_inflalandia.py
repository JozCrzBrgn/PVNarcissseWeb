    ...
    if name=="Juan Tinajero" or name=="Sr. Silvia":
        ...
        if lista_ids != []:
            ...
            if st.button("Generar PDF 📑"):
                data_celeb = config.supabase.table(tabs_pedidos[sucursal_infla]).select("clave,cliente,fecha_entrega,hora_entrega,personas").execute().data
                ...
                df_pdf = df_pedidos_seleccionados[['clave', 'cliente', 'personas', 'fecha_formateda', 'hora_entrega']]
                print(df_pdf)
